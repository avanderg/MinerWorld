...
final class Functions
{
    ...
    public static final String ASH_KEY = "ash";
    public static final String ASH_ID = "ash";

    public static final String WYVERN_KEY = "wyvern";
    public static final int WYVERN_ID = 1;
    public static final int WYVERN_ACTION_PERIOD = 5;
    public static final int WYVERN_ANIMATION_PERIOD = 6;
    public static final int WYVERN_ANIMATION_MIN = 50;
